                ...
                .clickable(
                    ...
                    onClick = {
                        ...
                        if (valuex.equals("+") || valuex.equals("-") || valuex.equals("*") || valuex.equals("/") ||
                            valuex.equals("%") || valuex.equals("^") || valuex.equals("√")|| valuex.equals("1/x")
                        ) {
                        ...
                        if (valuex.equals("=")) {
                            if (oldTextState.isNotEmpty()) {
                                ...
                                when (op) {
                                    ...
                                    // Manejo de la constante pi
                                    "π" -> {
                                        finalNumber = oldTextState.toDouble() * Math.PI
                                    }
                                    "1/x" -> finalNumber = 1 / oldTextState.toDouble()
                                }
    ...
    CalcJPCTheme() {
        Column {
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                var listE = listOf<String>("0", ".", "π","1/x")
                var listF = listOf<String>("=")
